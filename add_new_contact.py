...
class add_new_contact(unittest.TestCase):
    ...
    def test_add_new_contact(self):
        ...
        wd.find_element_by_name("firstname").send_keys("Jane")
        ...
        wd.find_element_by_name("address").send_keys("1 Happy Lane")
        wd.find_element_by_name("address").click()
        wd.find_element_by_name("address").clear()
        wd.find_element_by_name("address").send_keys("1 Happy Lane
London")
...
W1 3PB")
        ...
        wd.find_element_by_name("email").send_keys("jane@doe.com")
